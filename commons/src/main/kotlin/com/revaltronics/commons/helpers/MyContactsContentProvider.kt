package com.revaltronics.commons.helpers

import android.content.Context
import android.database.Cursor
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.revaltronics.commons.extensions.getIntValue
import com.revaltronics.commons.extensions.getStringValue
import com.revaltronics.commons.models.PhoneNumber
import com.revaltronics.commons.models.SimpleContact
import com.revaltronics.commons.models.contacts.*
import androidx.core.net.toUri
import com.revaltronics.commons.extensions.getStringValueOrNull
...
class MyContactsContentProvider {
    companion object {
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.revaltronics.autophone" && packageName != "com.revaltronics.smsmessenger" && packageName != "com.revaltronics.calendar") {
                return contacts
            }
        ...
        fun getContacts(context: Context, cursor: Cursor?): ArrayList<Contact> {
            ...
            val packageName = context.packageName.removeSuffix(".debug")
            if (packageName != "com.revaltronics.autophone" && packageName != "com.revaltronics.smsmessenger" && packageName != "com.revaltronics.calendar"
                && packageName != "com.revaltronics.autophone.debug" && packageName != "com.revaltronics.smsmessenger.debug" && packageName != "com.revaltronics.calendar.debug") {
                return contacts
            }

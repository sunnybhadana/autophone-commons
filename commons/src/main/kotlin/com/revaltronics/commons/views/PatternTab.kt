...
import com.revaltronics.commons.databinding.TabPatternBinding
...
import com.revaltronics.commons.extensions.performHapticFeedback
import com.revaltronics.commons.extensions.updateTextColors
import com.revaltronics.commons.helpers.PROTECTION_PATTERN
import com.revaltronics.commons.interfaces.BaseSecurityTab
import com.revaltronics.commons.interfaces.HashListener
...
class PatternTab(context: Context, attrs: AttributeSet) : BaseSecurityTab(context, attrs) {
    ...
    override fun initTab(
        ...
        if (computedHash != "") binding.patternLockTitle.setText(com.revaltronics.strings.R.string.enter_pattern)
    }

...
import com.revaltronics.commons.databinding.DialogTitleBinding
import com.revaltronics.commons.dialogs.*
import com.revaltronics.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.revaltronics.commons.helpers.*
import com.revaltronics.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import com.revaltronics.commons.helpers.MyContentProvider.MY_CONTENT_URI
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null, key: String = "") {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.revaltronics.autophone.debug" else "com.revaltronics.autophone"
                val className = "com.revaltronics.autophone.activities.DialerActivity"

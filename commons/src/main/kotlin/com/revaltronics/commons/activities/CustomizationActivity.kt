...
import com.revaltronics.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import com.revaltronics.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import com.revaltronics.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import com.revaltronics.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import com.revaltronics.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import com.revaltronics.commons.helpers.MyContentProvider.COL_THEME_TYPE
import com.revaltronics.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import com.revaltronics.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import com.revaltronics.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import com.revaltronics.commons.models.GlobalConfig
import com.revaltronics.commons.models.MyTheme
import com.revaltronics.commons.models.RadioItem
import com.revaltronics.commons.models.isGlobalThemingEnabled
...
//        binding.applyToAll.setTextColor(primaryColor.getContrastColor())
        ...
        binding.customizationAppIconColorHolder.setOnClickListener {
            if (baseConfig.wasAppIconCustomizationWarningShown || !isProVersion()) {
                ...
                val message = resources.getString(com.revaltronics.strings.R.string.app_icon_color_shortcuts_warning_g) + "\n\n" +
                    resources.getString(com.revaltronics.strings.R.string.app_icon_color_warning_g)
                ConfirmationDialog(this, message, com.revaltronics.strings.R.string.app_icon_color_warning_g, R.string.ok, 0) {
    ...
    private fun pickAppIconColor() {
        IconListDialog(
            ...
            descriptionId = resources.getString(com.revaltronics.strings.R.string.app_icon_color_shortcuts_warning_g) + "\n\n"
                + resources.getString(com.revaltronics.strings.R.string.app_icon_color_warning_g)
    ...
    private fun applyToAll() {
        when {
            ...
            isPro() -> {
                ...
                ConfirmationDialog(this, "", com.revaltronics.strings.R.string.global_theme_success_g, R.string.ok, 0) {
                    updateColorTheme(getCurrentThemeId())
                    saveChanges(false)
                }
            }
    ...
    private fun setupUseAccentColor() {
        binding.apply {
            ...
            customizationUseAccentColorFaq.setOnClickListener {
                ConfirmationDialog(this@CustomizationActivity, messageId = com.revaltronics.strings.R.string.use_accent_color_summary, positive = com.revaltronics.commons.R.string.ok, negative = 0) {}
            }
        }
    }
